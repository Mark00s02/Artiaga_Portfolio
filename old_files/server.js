...
async function seedData() {
  ...
  if (reviewsCount === 0) {
    await db.reviews.insert([
      { name: "Javier Cruz",  role: "CTO, CodeBoard",            rating: 5, text: "Mark's full-stack skills are insane. He built our entire platform from scratch in record time and the code quality is top-tier. One of the best devs we've worked with.", date: "2025-12-01", approved: true, createdAt: Date.now() },
      ...
      { name: "Paulo Reyes",  role: "Indie Dev",                 rating: 5, text: "Collaborated with Mark on a jam game and he carried hard. His Unity skills are no joke — got our prototype running in 48 hours flat.", date: "2025-07-11", approved: true, createdAt: Date.now() },
    ]);
...
// ============================================================
// AI CHATBOT — powered by Google Gemini (free)
// ============================================================
app.post('/api/chat', async (req, res) => {
  ...
  try {
    ...
    const systemPrompt = `You are an AI assistant on the portfolio website of Mark00s — a Full Stack & Game Developer based in the Philippines. You represent Mark professionally to visitors, clients, and recruiters.
...
== BEHAVIOR ==
- Be friendly, concise, and professional — like a smart assistant who knows Mark personally
- Answer questions about Mark's skills, projects, availability, and background confidently
- You can also answer general coding/tech questions — you're a helpful general assistant too
- If asked something unknown (exact rate, personal contact), admit you're unsure and suggest visiting the Reviews/Contact section
- Keep replies short and punchy — this is a portfolio site chat, not an essay
- Match the site's techy, gaming-dev vibe — casual but sharp
- Never fabricate projects or reviews — only reference what's listed above
- If someone wants to hire Mark, encourage them enthusiastically and direct them to the contact/reviews section`;
